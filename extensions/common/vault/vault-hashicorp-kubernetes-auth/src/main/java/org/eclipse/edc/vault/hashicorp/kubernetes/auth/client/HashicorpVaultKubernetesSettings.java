...
package org.eclipse.edc.vault.hashicorp.kubernetes.auth.client;
...
public class HashicorpVaultKubernetesSettings {
    ...
    @Setting(description = "The role that should be requested while using the kubernetes authentication method",  key = VAULT_KUBERNETES_AUTH_ROLE)
